...
# clean data 
data/clean/training.feather data/clean/test.feather : data/raw/default_of_credit_card_clients.feather
		Rscript src/clean_split_cred.r --input=data/raw/default_of_credit_card_clients.feather --out_dir=data/clean

# process data
data/processed/training.feather data/processed/test.feather : data/clean/training.feather data/clean/test.feather
